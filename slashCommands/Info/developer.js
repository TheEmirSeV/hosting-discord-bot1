...
module.exports = {
	...
	run: async (client, interaction, cmduser, es, ls, prefix, player, message) => {
		...
		try {	
			...
			let button_support_dc = new MessageButton().setStyle('LINK').setLabel(client.la[ls].cmds.info.developer.buttons.dc).setURL("https://discord.gg/6z48PW6tDN")
			...
			interaction?.reply({embeds: [new MessageEmbed()
				...
				.setTimestamp()
				.setThumbnail("https://cdn.discordapp.com/avatars/614856625173430294/df7b527a701d9a1ab6d73213576fe295.webp?size=1024")
