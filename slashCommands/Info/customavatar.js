    ...
    if (customavatar) {
      let embed = new MessageEmbed()
        .setAuthor(handlemsg(client.la[ls].cmds.info.avatar.author, {
          usertag: user.tag
        }), customavatar, "https://discord.gg/6z48PW6tDN")
        .setColor(es.color).setThumbnail(es.thumb ? es.footericon && (es.footericon.includes("http://") || es.footericon.includes("https://")) ? es.footericon : client.user.displayAvatarURL() : null)
        .addField("<:arrow_right:967045783377559572> PNG", `[\`LINK\`](${customavatar})`, true)
        .addField("<:arrow_right:967045783377559572> JPEG", `[\`LINK\`](${customavatar.replace("png", "jpg").replace("gif", "jpg")})`, true)
        .addField("<:arrow_right:967045783377559572> WEBP", `[\`LINK\`](${customavatar.replace("png", "webp").replace("gif", "webp")})`, true)
        .setURL(customavatar)
      ...
      let embed = new MessageEmbed()
        .setAuthor(handlemsg(client.la[ls].cmds.info.avatar.author, {
          ...
          dynamic: true
        }), "https://discord.gg/6z48PW6tDN")
        .setColor(es.color).setThumbnail(es.thumb ? es.footericon && (es.footericon.includes("http://") || es.footericon.includes("https://")) ? es.footericon : client.user.displayAvatarURL() : null)
        .addField("<:arrow_right:967045783377559572> PNG", `[\`LINK\`](${user.displayAvatarURL({format: "png"})})`, true)
        .addField("<:arrow_right:967045783377559572> JPEG", `[\`LINK\`](${user.displayAvatarURL({format: "jpg"})})`, true)
        .addField("<:arrow_right:967045783377559572> WEBP", `[\`LINK\`](${user.displayAvatarURL({format: "webp"})})`, true)
