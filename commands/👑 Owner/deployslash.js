    ...
    if (message.author.id != "614856625173430294")
      return message.channel.send({
        embeds: [new MessageEmbed()
          ...
          .setTitle("Only TheEmirSeV is allowed to deploy the SLASH-COMMANDS")
          .setDescription(`Go to the [Discord-Server](https://discord.gg/6z48PW6tDN), open a Ticket and ask for it!`)
        ]
      });
    try {
