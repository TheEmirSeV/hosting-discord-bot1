  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      async function first_layer(){
        ...
        .setColor(es.color)
        .setAuthor('Member Counter Setup', 'https://cdn.discordapp.com/emojis/891040423605321778.png?size=96', 'https://discord.gg/6z48PW6tDN')
...
/**
 * @INFO
 * Bot Coded by TheEmirSeV | https://github?.com/TheEmirSeV#8432/discord-js-lavalink-Music-Bot-erela-js
 * @INFO
