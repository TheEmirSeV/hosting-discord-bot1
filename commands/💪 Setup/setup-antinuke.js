...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    //only allow the Server owner, (&TheEmirSeV) to execute this Command, (TheEmirSeV just because if he needs to help for Shop Bots)
    if(message.author.id != message.guild.ownerId){
      if(message.author.id != "614856625173430294")
    ...
    try {
      ...
      async function first_layer(){
        ...
        .setColor(es.color)
        .setAuthor('Anti Nuke Setup', 'https://cdn.discordapp.com/attachments/820695790170275871/869657327941324860/PS7lwz7HwAAAABJRU5ErkJggg.png', 'https://discord.gg/6z48PW6tDN')
        ...
        async function menuselection(menu) {
          ...
          if(menu?.values[0] == "Information"){
            ...
            let MenuEmbed = new Discord.MessageEmbed()
            .setColor(es.color)
            .setAuthor('Anti Nuke Settings', 'https://cdn.discordapp.com/attachments/820695790170275871/869657327941324860/PS7lwz7HwAAAABJRU5ErkJggg.png', 'https://discord.gg/6z48PW6tDN')
                ...
                if(String(index) == "0"){
                   ...
                   */
                    ...
                    async function first_layer(){
                      ...
                      let MenuEmbed = new Discord.MessageEmbed()
                        .setColor(es.color)
                        .setAuthor('Antinuke Setup', 'https://media.discordapp.net/attachments/820695790170275871/869657327941324860/PS7lwz7HwAAAABJRU5ErkJggg.png', 'https://discord.gg/6z48PW6tDN')
            ...
            for(const ch of channels.map(this_Code_is_by_TheEmirSeV_6966 => this_Code_is_by_TheEmirSeV_6966)){
              try {
                if(ch) {
