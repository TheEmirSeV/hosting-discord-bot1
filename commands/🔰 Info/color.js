  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    let ls = client.settings.get(message.guild.id, "language")
      ...
      const embed = new Discord.MessageEmbed()
        ...
        .addField('<:arrow_right:967045783377559572> **Name**', "```"+json.name+"```", true)
        .addField("<:arrow_right:967045783377559572> **Hex**",  "```"+json.hex+"```", true)
        .addField("<:arrow_right:967045783377559572> **RGB**",  "```"+json.rgb+"```", true)
        .addField(`<:arrow_right:967045783377559572> **${client.la[ls].cmds.info.color.brightershade}**`,  "```"+json.brightened +"```", true)
