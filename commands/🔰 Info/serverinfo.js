...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix, player) => {
    ...
    try {
      ...
      embed.addField("**<:arrow_right:967045783377559572> Rules Channel:**", `${message.guild.rulesChannel ? `<#${message.guild.rulesChannelId}>`: "❎ \`No Channel\`"}`, true)
      embed.addField("**<:arrow_right:967045783377559572> Public Updates Channel:**", `${message.guild.publicUpdatesChannel ? `<#${message.guild.publicUpdatesChannelId}>`: "❎ \`No Channel\`"}`, true)
      embed.addField("**<:arrow_right:967045783377559572> AFK Channel:**", `${message.guild.afkChannel ? `<#${message.guild.afkChannelId}>`: "❎ \`No Channel\`"}`, true)

      embed.addField("**<:arrow_right:967045783377559572> NSFW Level:**", `\`${message.guild.nsfwLevel}\``, true)
      embed.addField("**<:arrow_right:967045783377559572> Verifcation Level:**", `\`${message.guild.verificationLevel}\``, true)
      embed.addField("**<:arrow_right:967045783377559572> Explicit Content Filter:**", `\`${message.guild.explicitContentFilter}\``, true)
      ...
      if(boosts >= 14){
          embed.addField(`**<:arrow_right:967045783377559572> Vanity:**`, `${message.guild.vanityURLCode ? `https://discord.gg/${message.guild.vanityURLCode}` : "❎ No Vanity-Invite"}`)
      }
      ...
      if(message.guild.banner) {
        ...
        .setTitle(`**<:arrow_right:967045783377559572> SERVER BANNER:**`)
        ...
        let embed2 = new Discord.MessageEmbed()
        .setTitle(`**<:arrow_right:967045783377559572> SERVER DISCOVERY SPLASH:**`)
