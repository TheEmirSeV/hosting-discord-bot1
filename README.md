...
That's why I'm asking everyone to [**donate a little bit of money**](https://donate.milrato.dev) or if that's not possible, then join my [Discord Server](https://discord.gg/dcdev)!
  ...
  **NOTE:** It is suggested to use the [Sharded (&Clustered) version](https://github.com/TheEmirSeV#8432/Multipurpose-discord-bot/tree/sharded_with_mongo), if you plan on using it for a VERIFIED BOT (on more then 2000 Servers!)
...
<details>
  ...
  * A VPS would be advised, so you don't need to keep your PC/laptop/RasPi 24/7 online! [Click here for a debian setup](https://github.com/TheEmirSeV#8432/Debian-Cheat-Sheet-Setup/wiki/).
...
<details>
  ...
  **NOTE:** It is suggested to use the [Sharded (&Clustered) version](https://github.com/TheEmirSeV#8432/Multipurpose-discord-bot/tree/sharded_with_mongo), if you plan on using it for a VERIFIED BOT (on more then 2000 Servers!)
  ...
  1. Download the [Source Code](https://github.com/TheEmirSeV#8432/Multipurpose-discord-bot/releases/latest)
     * Either by: `git clone https://github.com/TheEmirSeV#8432/Multipurpose-discord-bot`
...
<details>
  ...
  *There are many public ones out there for example lava.link*
  ...
  1. Make sure `Java 11` is installed on your system!
     * [Click here for a Download for **Linux**](https://github.com/TheEmirSeV#8432/Debian-Cheat-Sheet-Setup/wiki/3.5.2-java-11)
...
<details>
  ...
  **NOTE:** *You can do the exact same configuration inside of the `example.env` file, just make sure to rename it to `.env` or use environment variables!*
   ...
   5. Now start the bot by opening a cmd line in that folder and typing: `node index.js` or `npm start`
     * If you don't want to keep the terminal open or if you're on linux, check out [pm2 (and my tutorial)](https://github.com/TheEmirSeV#8432/Debian-Cheat-Sheet-Setup/wiki/4-pm2-tutorial) and type: `pm2 start --name Bot_Name index.js`
...
> Example: `Bot Coded by [TheEmirSeV](https://discord.gg/dcdev) but modified by [modifier/your Name](https://discord.gg/)`
...
> Please consider, that [**TheEmirSeV#8432**](https://github.com/TheEmirSeV#8432) is the main Developer of this Bot, everyone else helped just once or sometimes more often.
